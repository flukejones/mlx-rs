...
//!
//! `use mlxr_lm::prelude::*;` brings the canonical building blocks
//! (cache, nn, sampler, loader) into scope. Models stay namespaced
//! (use `mlxr_lm::models::<family>` explicitly) since the per-model
...
pub use crate::sampler::{sample, sample_with, top_p_sample, Sampler, SamplerState};
