...
use mlxr::fast::MetalKernel;

use super::fused_quantized_sdpa::make_fused_qsdpa_kernel;
use crate::attention::{make_attention_kernel, make_quant_attention_kernel};
...
pub(crate) const SUPPORTED_HEAD_DIMS: &[i32] = &[128, 256, 512];
...
pub(crate) fn cached_attention_kernel() -> &'static MetalKernel {
    static KERNEL: OnceLock<MetalKernel> = OnceLock::new();
