//! KV-cache unit tests. Moved out of `crates/mlxr-lm/src/cache/mod.rs`
//! so a grep for "cache" doesn't hit ~600 lines of test fixtures.
...
fn prompt_cache_kvcache_round_trip() {
    ...
    match &loaded[0] {
        ...
        other => panic!("expected plain KVCache, got {other:?}"),
    }
}
...
fn prompt_cache_quantized_round_trip() {
    ...
    match &loaded[0] {
        ...
        other => panic!("expected quantized cache, got {other:?}"),
    }
}
