...
pub fn topk_axis_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_topk_axis(res, a.as_ref().as_ptr(), k, axis, stream.as_ref().as_ptr())
    })
}
...
pub fn topk_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_topk(res, a.as_ref().as_ptr(), k, stream.as_ref().as_ptr())
    })
}
...
pub fn scatter_add_single_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_scatter_add_single(
            res,
            a.as_ref().as_ptr(),
            indices.as_ref().as_ptr(),
            updates.as_ref().as_ptr(),
...
pub fn scatter_max_single_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_scatter_max_single(
            res,
            a.as_ref().as_ptr(),
            indices.as_ref().as_ptr(),
            updates.as_ref().as_ptr(),
...
pub fn scatter_min_single_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_scatter_min_single(
            res,
            a.as_ref().as_ptr(),
            indices.as_ref().as_ptr(),
            updates.as_ref().as_ptr(),
...
pub fn scatter_prod_single_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_scatter_prod_single(
            res,
            a.as_ref().as_ptr(),
            indices.as_ref().as_ptr(),
            updates.as_ref().as_ptr(),
