...
impl Array {
    ...
    pub fn logical_not_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_logical_not(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
...
pub fn is_nan_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_isnan(res, array.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn is_inf_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_isinf(res, array.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn is_pos_inf_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_isposinf(res, array.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn is_neg_inf_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_isneginf(res, array.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
