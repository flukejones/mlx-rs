...
fn optional_int(value: Option<i32>, default: i32) -> mlxr_sys::mlx_optional_int {
    mlxr_sys::mlx_optional_int {
...
fn optional_dtype_none() -> mlxr_sys::mlx_optional_dtype {
    mlxr_sys::mlx_optional_dtype {
        value: mlxr_sys::mlx_dtype__MLX_FLOAT32, // default value, ignored when has_value is false
        has_value: false,
    }
}
...
pub fn quantize_device(
    ...
    let result = VectorArray::try_from_op(|res| unsafe {
        mlxr_sys::mlx_quantize(
            res,
            w.as_ref().as_ptr(),
            group_size,
            bits,
            DEFAULT_MODE.as_ptr(),
            mlxr_sys::mlx_array_new(),
