...
impl Array {
    ...
    pub fn abs_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_abs(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn negative_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_negative(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn sqrt_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_sqrt(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn cos_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_cos(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn exp_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_exp(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn floor_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_floor(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn is_nan_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_isnan(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn is_inf_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_isinf(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn is_finite_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_isfinite(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn is_neg_inf_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_isneginf(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn is_pos_inf_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_isposinf(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn log_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_log(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn log2_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_log2(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn log10_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_log10(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn log1p_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_log1p(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn reciprocal_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_reciprocal(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn rsqrt_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_rsqrt(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn sin_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_sin(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn square_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_square(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn real_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_real(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
    ...
    pub fn imag_device(&self, stream: impl AsRef<Stream>) -> Result<Self> {
        Self::try_from_op(|res| unsafe {
            mlxr_sys::mlx_imag(res, self.as_ptr(), stream.as_ref().as_ptr())
        })
    }
}
...
pub fn acos_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_arccos(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn acosh_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_arccosh(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn asin_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_arcsin(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn asinh_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_arcsinh(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn atan_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_arctan(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn atan2_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_arctan2(res, a.as_ptr(), b.as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn atanh_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_arctanh(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn ceil_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_ceil(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn cosh_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_cosh(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn degrees_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_degrees(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn divmod_device(
    ...
    let vec = VectorArray::try_from_op(|res| unsafe {
        mlxr_sys::mlx_divmod(res, a_ptr, b_ptr, stream.as_ref().as_ptr())
    })?;
...
pub fn erf_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_erf(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn erfinv_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_erfinv(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn expm1_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_expm1(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn logaddexp_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_logaddexp(res, a_ptr, b_ptr, stream.as_ref().as_ptr())
    })
}
...
///
/// ```rust,ignore
/// use mlxr::{Array, ops::segmented_mm};
///
...
pub fn maximum_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_maximum(res, a_ptr, b_ptr, stream.as_ref().as_ptr())
    })
}
...
pub fn minimum_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_minimum(res, a_ptr, b_ptr, stream.as_ref().as_ptr())
    })
}
...
pub fn radians_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_radians(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn sigmoid_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_sigmoid(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn sign_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_sign(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn sinh_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_sinh(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn softmax_axis_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_softmax_axis(res, a.as_ref().as_ptr(), axis, precise, s)
    })
}
...
pub fn softmax_device(
    ...
    Array::try_from_op(|res| unsafe { mlxr_sys::mlx_softmax(res, a.as_ref().as_ptr(), precise, s) })
}
...
pub fn tan_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_tan(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn tanh_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_tanh(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn real_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_real(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn imag_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_imag(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn block_masked_mm_device<'mo, 'lhs, 'rhs>(
    ...
    unsafe {
        let mask_out_ptr = mask_out
            .into()
            .map(|m| m.as_ptr())
            .unwrap_or_else(|| mlxr_sys::mlx_array_new());
...
pub fn inner_device(
    ...
    let b = b.as_ref();
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_inner(res, a.as_ptr(), b.as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn outer_device(
    ...
    let b = b.as_ref();
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_outer(res, a.as_ptr(), b.as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn tensordot_axis_device(
    ...
    let b = b.as_ref();
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_tensordot_axis(res, a.as_ptr(), b.as_ptr(), axis, stream.as_ref().as_ptr())
    })
}
