...
pub fn sort_axis_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_sort_axis(res, a.as_ref().as_ptr(), axis, stream.as_ref().as_ptr())
    })
}
...
pub fn sort_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_sort(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn argsort_axis_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_argsort_axis(res, a.as_ref().as_ptr(), axis, stream.as_ref().as_ptr())
    })
}
...
pub fn argsort_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_argsort(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn partition_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_partition(res, a.as_ref().as_ptr(), kth, stream.as_ref().as_ptr())
    })
}
...
pub fn argpartition_axis_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_argpartition_axis(
            res,
            a.as_ref().as_ptr(),
            kth,
            axis,
...
pub fn argpartition_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_argpartition(res, a.as_ref().as_ptr(), kth, stream.as_ref().as_ptr())
    })
}
