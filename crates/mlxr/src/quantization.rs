...
#[cfg(all(test, feature = "layers"))]
mod tests {
    #![allow(clippy::unwrap_used, reason = "test code")]
    #![allow(clippy::missing_assert_message, reason = "test code")]
    #![allow(clippy::print_stdout, reason = "test code")]
    #![allow(clippy::print_stderr, reason = "test code")]
    use crate::layers::{self, Embedding, Linear};
    ...
    fn test_quantizable_linear() {
        ...
        qlinear = layers::quantize(qlinear, None, None).unwrap();
        assert!(qlinear.is_quantized());
    }
    ...
    fn test_quantizable_embedding() {
        ...
        qembedding = layers::quantize(qembedding, None, None).unwrap();
        assert!(qembedding.is_quantized());
    }
}
