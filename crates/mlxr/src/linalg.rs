...
///
/// ```rust
/// use mlxr::{Array, StreamOrDevice, linalg::*};
///
...
pub fn qr_device(
    ...
    <(Array, Array)>::try_from_op(|(res_0, res_1)| unsafe {
        mlxr_sys::mlx_linalg_qr(res_0, res_1, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn svd_device(
    ...
    let v = VectorArray::try_from_op(|res| unsafe {
        mlxr_sys::mlx_linalg_svd(res, array.as_ref().as_ptr(), true, stream.as_ref().as_ptr())
    })?;
...
pub fn inv_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_linalg_inv(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
///
/// ```rust
/// use mlxr::{Array, linalg::*, StreamOrDevice};
///
...
pub fn eig_device(
    ...
    <(Array, Array) as Guarded>::try_from_op(|(res_0, res_1)| unsafe {
        mlxr_sys::mlx_linalg_eig(res_0, res_1, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn eigvals_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_linalg_eigvals(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn pinv_device(a: impl AsRef<Array>, #[optional] stream: impl AsRef<Stream>) -> Result<Array> {
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_linalg_pinv(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn tri_inv_device(
    ...
    let upper = upper.unwrap_or(false);
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_linalg_tri_inv(res, a.as_ref().as_ptr(), upper, stream.as_ref().as_ptr())
    })
}
...
pub fn lu_device(
    ...
    let v = Vec::<Array>::try_from_op(|res| unsafe {
        mlxr_sys::mlx_linalg_lu(res, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })?;
...
pub fn lu_factor_device(
    ...
    <(Array, Array)>::try_from_op(|(res_0, res_1)| unsafe {
        mlxr_sys::mlx_linalg_lu_factor(res_0, res_1, a.as_ref().as_ptr(), stream.as_ref().as_ptr())
    })
}
...
pub fn solve_triangular_device(
    ...
    Array::try_from_op(|res| unsafe {
        mlxr_sys::mlx_linalg_solve_triangular(
            res,
            a.as_ref().as_ptr(),
            b.as_ref().as_ptr(),
            upper,
