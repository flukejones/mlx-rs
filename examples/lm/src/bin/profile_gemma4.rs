//! Instrumented gemma4 decode profiler. Times each major sub-launch
//! group per layer with `eval`-fenced wall-clock to attribute cost to
//! attention / dense MLP / router / experts / epilogue. Run once and
//! eyeball the breakdown to decide where to fuse.
//!
//! Usage:
